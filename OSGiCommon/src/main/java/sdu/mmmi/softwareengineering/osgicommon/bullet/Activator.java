...
public class Activator implements BundleActivator {
    ...
    public void start(BundleContext context) throws Exception {
        context.registerService(IGamePluginService.class, new BulletPlugin(), null);
        context.registerService(IEntityProcessingService.class, new BulletControlSystem(), null);
    }
